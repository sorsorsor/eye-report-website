...
<div class="tweets-pulled-listing">
  ...
  <?php if (!empty($title)): ?>
    <h4><a href="https://twitter.com/aiww" class="heading-link"><?php print $title; ?></a></h4>
  <?php endif; ?>
  ...
  <?php if (is_array($tweets)): ?>
    ...
    <?php foreach ($tweets as $tweet_key => $tweet): ?>
      <li>
	<div class="tweet-time subheading"><?php print l($tweet->time_ago, 'http://twitter.com/' . $tweet->username . '/status/' . $tweet->id);?></div>
